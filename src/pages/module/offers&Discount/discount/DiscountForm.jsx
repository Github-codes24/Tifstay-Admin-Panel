...
export function DiscountForm({ mode, discount, onSubmit }) {
  ...
  return (
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
     ...
     <button onClick={handleSubmit} className="bg-blue-600 hover:bg-blue-700 text-white px-12 py-3 rounded-lg font-medium text-base h-auto">{mode === 'create' ? 'Create' : 'Update'}</button>
            </div>
    </div>
  );
}
